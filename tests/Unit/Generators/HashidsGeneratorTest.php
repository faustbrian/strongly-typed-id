...
describe('HashidsGenerator', function (): void {
    ...
    describe('Regressions', function (): void {
        ...
        test('salt parameter actually affects id generation', function (): void {
            ...
            // Act
            $ids1 = array_map(fn (): string => $generator1->generate(), range(1, 100));
            $ids2 = array_map(fn (): string => $generator2->generate(), range(1, 100));
            $ids3 = array_map(fn (): string => $generator3->generate(), range(1, 100));
