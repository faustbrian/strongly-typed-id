...
describe('UuidV5Generator', function (): void {
    describe('Happy Paths', function (): void {
        test('generates valid uuid v5 string with default namespace', function (): void {
            // Arrange
        ...
        test('generates valid uuid with custom namespace', function (): void {
            ...
            $generator = new UuidV5Generator($customNamespace, 'https://example.com');
        ...
        test('different namespaces produce different uuids for same name', function (): void {
            // Arrange
            $generator1 = new UuidV5Generator(Uuid::NAMESPACE_DNS, 'example.com');
            $generator2 = new UuidV5Generator(Uuid::NAMESPACE_URL, 'example.com');
        ...
        test('different names produce different uuids for same namespace', function (): void {
            // Arrange
            $generator1 = new UuidV5Generator(Uuid::NAMESPACE_DNS, 'example.com');
            $generator2 = new UuidV5Generator(Uuid::NAMESPACE_DNS, 'different.com');
        ...
        test('v5 produces different uuid than v3 for same inputs', function (): void {
            // Arrange
            $namespace = Uuid::NAMESPACE_DNS;
            $name = 'example.com';
            $generatorV3 = new UuidV3Generator($namespace, $name);
            $generatorV5 = new UuidV5Generator($namespace, $name);

            // Act
            $idV3 = $generatorV3->generate();
            $idV5 = $generatorV5->generate();

            // Assert - Different hash algorithms produce different UUIDs
            expect($idV3)->not->toBe($idV5);
        });
    });
    ...
    describe('Edge Cases', function (): void {
        test('generates consistent uuid with empty string name', function (): void {
            // Arrange
            $generator = new UuidV5Generator(Uuid::NAMESPACE_DNS, '');
        ...
        test('handles unicode characters in name', function (): void {
            // Arrange
            $generator = new UuidV5Generator(Uuid::NAMESPACE_DNS, '你好世界');
