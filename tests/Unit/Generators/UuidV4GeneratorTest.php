...
describe('UuidV4Generator', function (): void {
    describe('Happy Paths', function (): void {
        test('generates valid uuid v4 string', function (): void {
            // Arrange
        ...
        test('generates random non-sequential uuids', function (): void {
            ...
            // Assert - UUID v4 is random, not guaranteed sortable
            expect($id1)->not->toBe($id2);
            // We cannot assert ordering with v4 as it's random
        });
    });
